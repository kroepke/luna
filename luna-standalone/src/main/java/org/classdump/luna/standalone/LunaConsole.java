...
public class LunaConsole {
  ...
  public LunaConsole(CommandLineArguments cmdLineArgs, InputStream in, PrintStream out,
      PrintStream err) {
  ...
  private void executeStdin(String[] args)
    ...
    executeProgram(Utils.skipLeadingShebang(source), Constants.SOURCE_STDIN,
        Objects.requireNonNull(args));
  }
  ...
  private void startInteractive() throws CallException, IOException {
    ...
    while ((line = reader.readLine()) != null) {
      ...
      if (fn == null) {
        ...
        try {
          fn = loader
              .loadTextChunk(new Variable(env), Constants.SOURCE_STDIN, codeBuffer.toString());
        } catch (LoaderException ex) {
