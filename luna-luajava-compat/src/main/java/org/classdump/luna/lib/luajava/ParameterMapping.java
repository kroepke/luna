...
abstract class ParameterMapping {
  ...
  static ParameterMapping forClass(Class<?> paramClazz) {
    // primitive types
    if (long.class.equals(paramClazz)) {
      return TO_LONG;
    } else if (int.class.equals(paramClazz)) {
      return TO_INT;
    } else if (short.class.equals(paramClazz)) {
      return TO_SHORT;
    } else if (byte.class.equals(paramClazz)) {
      return TO_BYTE;
    } else if (char.class.equals(paramClazz)) {
      return TO_CHAR;
    } else if (double.class.equals(paramClazz)) {
      return TO_DOUBLE;
    } else if (float.class.equals(paramClazz)) {
      return TO_FLOAT;
    } else if (boolean.class.equals(paramClazz)) {
      return TO_BOOLEAN;
    }

    // reference type
    else {
      return new Unwrap(paramClazz);
    }
  }
